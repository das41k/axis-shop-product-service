...
class ProductUpdate(BaseModel):
    ...
    price: Optional[float] = Field(None, gt = 0, description = "Цена обязательна и должна быть больше 0")
    quantity: Optional[int] = Field(None, ge = 0, description="Количество обьязательно и не может быть отрицательным")
        
    category_id: Optional[int] =  Field(None, gt= 0, description="ID категории обязателен и больше 0")