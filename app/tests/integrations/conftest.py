...
def schema_category_create_valid():
    return CategoryCreate(
        title="Туалет", description="Товары для туалета"
    )
...
@pytest.fixture
async def create_category_with_products(test_async_session, create_category) -> Category:
    category = create_category
    products_data = [
        {"title": "Вилка", "description": "Удобная вилка", "price": 100, "quantity": 3},
        {"title": "Ложка", "description": "Удобная ложка", "price": 200, "quantity": 4},
    ]
    products = []
